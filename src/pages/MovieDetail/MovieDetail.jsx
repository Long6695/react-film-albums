...
const MovieDetail = () => {
  ...
  return (
    <>
      <Title style={styledText} level={2}>Film Detail</Title>
      <Row>
        <Col span={24} style={isMobile ? {display: 'flex', flexDirection: 'column'} : {display: 'flex'}}>
          <div style={{maxWidth: '300px', marginRight: '20px'}}>
            <img style={{width: '100%', objectFit: 'cover'}} src={film.banner} alt={film.title} />
          </div>
          <div style={{display: 'flex', flexDirection: 'column', justifyContent: 'space-between'}}>
            <Title style={styledText} level={3}>{film.title}</Title>
